"""
Quick test of the workflow to see if itinerary generation works
"""
import sys
import os
...
print("=" * 70)
print("Testing Workflow - Itinerary Generation")
print("=" * 70)
print()
...
try:
    ...
    print()
    print("=" * 70)
    print("TEST PASSED! Workflow is working!")
    print("=" * 70)
